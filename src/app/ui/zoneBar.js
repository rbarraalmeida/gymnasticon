...
export const ZONES = [
    ...
    {id: 2, start:  56, finish:  76, color: 15, lightColor: 15, bgColor:  85, lightBgColor:  48, name: "Endurance"}, // blue
    {id: 3, start:  76, finish:  91, color: 15, lightColor: 15, bgColor:  81, lightBgColor:  57, name: "Tempo"}, // green
    {id: 4, start:  91, finish: 106, color:  0, lightColor:  0, bgColor:  43, lightBgColor:  92, name: "Lactate Threshold"}, // yellow
...
const CUR_ZONE_HEIGHT = 5;
const NEXT_ZONE_HEIGHT = 5;
const FAR_ZONE_HEIGHT = 5;
const ZONE_WIDTH = 3;
